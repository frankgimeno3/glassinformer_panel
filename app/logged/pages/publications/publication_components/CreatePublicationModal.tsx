    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-4">
          {[
            ["ID de Publicación", idPublication, setIdPublication],
            ["Enlace de Redirección", redirectionLink, setRedirectionLink],
            ["Revista", revista, setRevista],
            ["Número", numero, setNumero],
